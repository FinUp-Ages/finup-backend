...
public class TransactionRecurrenceService {
  ...
  /**
   * Busca uma recorrencia pelo identificador.
   *
   * @throws ResourceNotFoundException se nao existir recorrencia com esse id
   */
  public TransactionRecurrence findById(UUID id) {
    return transactionRecurrenceRepository
        .findById(id)
        .orElseThrow(() -> new ResourceNotFoundException("TransactionRecurrence", id));
  }
